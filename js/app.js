...
const album1 = {
  ...
  console.log(album3.albumDetails.formats.push('LP'))
  
  
  // Exercise 4:  Update the released property of album3 from a string into a Date object using that string
 
 album3.albumDetails.released  = new Date
 console.log('Exercise4',album3.albumDetails.released  = new Date) 
 ...
 console.log('Exercis5',album4.albumDetails.label)
  ...
  console.log('Exercise6',album5.albumDetails.labels[1].toUpperCase())
  ...
  //console.log(Object.values(album6.albumDetails.formats));
  ...
  let albumDetails = talkingHeadsAlbums;
